...
<div>
    ...
    <div class="flex items-center justify-between mb-4">
        <div><flux:heading size="xl">Edit Bus ({{ $bus->id }}) <span class="font-extrabold">{{ $bus->name }}</span></flux:heading></div>
        <div class="flex items-center gap-4">
                                ...
                                @if($bus->details_pic)
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="space-y-1">
                                            ...
                                            <flux:button variant="danger" wire:click="removeDetailsPic" type="button">

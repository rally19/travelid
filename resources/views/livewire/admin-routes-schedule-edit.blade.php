...
<div>
    <div class="flex items-center justify-between mb-4 sm:hidden">
        <div>
            <flux:button icon="eye" :href="route('admin.view.routes-schedule', ['id' => $route->id])" wire:navigate></flux:button>
        </div>
    ...
    <div class="flex items-center justify-between mb-4">
        <div><flux:heading size="xl">Edit Route Schedule ({{ $route->id }}) <span class="font-extrabold">{{ $route->name }}</span></flux:heading></div>
        <div class="flex items-center gap-4">

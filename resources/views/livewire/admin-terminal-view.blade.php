...
<div>
    <div class="flex items-center justify-between mb-4 sm:hidden">
        <div>
            <flux:button icon="pencil" :href="route('admin.edit.terminal', ['id' => $terminal->id])" wire:navigate></flux:button>
        </div>
    ...
    <div class="flex items-center justify-between mb-4">
        <div><flux:heading size="xl">View Terminal ({{ $terminal->id }}) <span class="font-extrabold">{{ $terminal->name }}</span></flux:heading></div>
        <div class="flex items-center gap-4">
